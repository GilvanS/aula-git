...
describe('Funcionalidade Pré Cadastro', () => {
    ...
    it('Deve completar o pré-cadastro com sucesso usando Comandos customazidos', () => {
        let emailFaker2 = fakerPT_BR.internet.email()
        cy.preCadastro(emailFaker2, 'senha!@#forte', 'Gilvan', 'Sousa')
        cy.get('.woocommerce-message').should('contain', 'Detalhes da conta modificados com sucesso.')
    });
});